...
# path -----------------------------------
path = 'C:/Users/dolif/Desktop/프로젝트/log/cwEC2logtest_CPUmax_web1.txt'
...
plt.savefig('C:/Users/dolif/Desktop/프로젝트/{0}-{1}_WEB2_CPU_MAX_graph.png'.format(nowDate,nowTime),dpi=300)
# plt.show()